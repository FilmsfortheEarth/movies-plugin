...
use Cms\FormWidgets\MediaFinder;
...
class MLMediaFinder extends MediaFinder
{
    ...
    protected function actAsParent($switch = true)
    {
        if ($switch) {
            ...
            $this->assetPath = '/modules/cms/formwidgets/mediafinder/assets';
            $this->viewPath = base_path().'/modules/cms/formwidgets/mediafinder/partials';
        }
        else {
